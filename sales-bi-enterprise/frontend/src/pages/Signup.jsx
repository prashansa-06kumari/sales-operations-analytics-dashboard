    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] flex items-center justify-center p-4 bg-grid relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white">Join Us</h1>
          <p className="text-slate-500 mt-2 font-bold uppercase text-[10px] tracking-[0.3em]">Create your account</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSignup}>
          <div className="space-y-3">
            ...
            <div className="relative group">
              <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 w-5 h-5 group-focus-within:text-brand-500 transition-colors" />
              <input 
                required
                type="text" 
        ...
        <div className="mt-10 pt-8 border-t dark:border-slate-800 text-center">
          <p className="text-slate-500 font-bold text-sm">
            ...
            <Link to="/login" className="text-brand-600 hover:text-brand-700 font-black uppercase tracking-widest text-xs ml-1">Sign In</Link>
          </p>
        </div>
      </motion.div>
    </div>
